...
function sharearrays() {
  ...
  TIMESTAMP_REGEXES=(
    ...
    "[0-9]{8}-[0-9]{6}"
    "[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}_[0-9]{2}_[0-9]{2}"
  )
  ...
  YEAR_POSITION=(0 0 0 0 0 0 0 0 0)
  MONTH_POSITION=(4 4 5 5 5 5 5 4 5)
  DAY_POSITION=(6 6 8 8 8 8 8 6 8)
  HOUR_POSITION=(8 9 11 11 14 14 11 9 11)
  HOUR_NUM_DIGITS=(2 2 1 2 1 2 2 2 2)
  HOUR_MODIFIER_POSITION=(-1 -1 19 20 22 23 -1 -1 -1)
  MINUTE_POSITION=(10 11 13 14 16 17 14 11 14)
  SECOND_POSITION=(12 13 16 17 19 20 17 13 17)
}
